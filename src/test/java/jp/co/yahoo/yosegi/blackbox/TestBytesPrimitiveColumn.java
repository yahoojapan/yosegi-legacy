...
public class TestBytesPrimitiveColumn {
  ...
  public static Stream<Arguments> data1() throws IOException {
    return Stream.of(arguments("jp.co.yahoo.yosegi.binary.maker.DumpBytesColumnBinaryMaker"));
  }
  ...
  @ParameterizedTest
  @MethodSource("data1")
  public void T_encodeAndDecode_equalsSetValue_withNotNull(final String targetClassName)
      throws IOException {
  ...
  @ParameterizedTest
  @MethodSource("data1")
  public void T_encodeAndDecode_equalsSetValue_withHasNull(final String targetClassName)
      throws IOException {
  ...
  @ParameterizedTest
  @MethodSource("data1")
  public void T_encodeAndDecode_equalsSetValue_lastCellOnly(final String targetClassName)
      throws IOException {
    // NOTE: Spread size must be passed because correct load size can't be gotten.
