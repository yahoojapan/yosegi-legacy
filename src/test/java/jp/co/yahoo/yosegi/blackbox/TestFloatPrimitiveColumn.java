...
public class TestFloatPrimitiveColumn {
  ...
  public static Stream<Arguments> data1() throws IOException {
    return Stream.of(
        arguments("jp.co.yahoo.yosegi.binary.maker.DumpFloatColumnBinaryMaker"),
        arguments("jp.co.yahoo.yosegi.binary.maker.OptimizeFloatColumnBinaryMaker"),
        arguments("jp.co.yahoo.yosegi.binary.maker.RangeDumpFloatColumnBinaryMaker"),
